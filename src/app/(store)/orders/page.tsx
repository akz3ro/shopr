          ...
          <div className="space-y-6 sm:space-y-8">
            {orders.map((order) => (
              <div
                ...
                className="p-4 sm:p-6 bg-white border border-gray-200 rounded-lg shadow-sm overflow-hidden"
              >
                  ...
                  <div className="space-y-3 sm:space-y-4">
                    {order.products?.map((product) => (
                      <Link
                        ...
                        className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 py-2 border-b last:border-b-0 hover:bg-gray-100 transition duration-300 rounded-md shadow-sm p-2 bg-white"
                      >
                        ...
                        <div>
                          <p className="font-medium text-gray-600 text-right">
                            {formatCurrency(
